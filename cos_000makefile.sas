...
%let gbl_tool     =  1             ;   * if 1 download driver and macro library and makefile;
%let gbl_dirsub   =  1             ;   * if 1 then build sub directories else 0;

%let gbl_zipzcta  =  1             ;   * dowload and create zip to zcta table;
%let gbl_celval   =  1             ;   * copy sort and index 15gb fact table;;
%let gbl_cstcop   =  1             ;   * if you make chages to source cos_100 macro;
%let gbl_ziptbl   =  1             ;   * if you make chages to source cos_150 macro;
%let gbl_example1 =  1             ;   * if you make changes to source cos_200 macro;
%let gbl_example2 =  1             ;   * if you make changes to source cos_250 macro;

%let gbl_makefile =  https://raw.githubusercontent.com/rogerjdeangelis/utl-cost-report-analysis/master/cos_000makefile.sas;
%let gbl_driver   =  https://raw.githubusercontent.com/rogerjdeangelis/utl-cost-report-analysis/master/cst_005driver.sas;
...
parmcards4;
%macro cos_050/des="download and create table zct_zip2zcta and format $zip2zcta";
  ...
  * https://www.udsmapper.org/zcta-crosswalk.cfm  zip to zcta crosswalk ;
  ...
  filename _bcot "&gbl_root:/cos/b64/cos_025zip2zcta_sas7bdat.b64";
  ...
  %utl_b64decode(&gbl_root:/cos/b64/cos_025zip2zcta_sas7bdat.b64,%sysfunc(pathname(work))/zct_zip2zcta.sas7bdat);
...
/*                         __                               _
  ___ ___  _ __  _   _   / _|_ __ ___  _ __ ___     ___ ___| |_
 / __/ _ \| `_ \| | | | | |_| `__/ _ \| `_ ` _ \   / __/ __| __|
| (_| (_) | |_) | |_| | |  _| | | (_) | | | | | | | (__\__ \ |_
 \___\___/| .__/ \__, | |_| |_|  \___/|_| |_| |_|  \___|___/\__|
          |_|    |___/
*/
...
filename ft15f001 "&gbl_oto/cos_125.sas";
parmcards4;
%macro cos_125/des="creates cel_cellValue tpl_template col_describe formats $cel2lbl adr_address $zip2zcta";
...
filename ft15f001 "&gbl_oto/cos_250.sas";
parmcards4;
...
%utlnopts;
%array(nms,values=%varlist(pre_365787,prx=/_N$/i));
